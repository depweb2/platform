function init() {
    ...
    if (!compatible) {
        ...
        $("a").hammer().on("press contextmenu", function (e) {
            ...
            } else if ($(e.target).is(".w3-context a img")){
                e.stopImPropagation();
            }else{
                e.preventDefault();
                e.stopPropagation();
...
jQuery.ajaxSetup({
    ...
    error: function (xhr) {
        ...
        var msg = "Impossible de charger le module. ";
        switch(xhr.status){
            case 0:
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            source = "<!DOCTYPE html>" +
                    ...
                    "</head>" +
                    "<body><div class='w3-modal fs' style='display: table !important;'><div class='w3-modal-dialog'><div class='w3-modal-content'><header class='w3-container w3-green'><h2><a class='nou close-link' href='javascript:window.close()'>" +
