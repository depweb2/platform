...
define('THUMBNAIL_IMAGE_MAX_WIDTH', 96);
define('THUMBNAIL_IMAGE_MAX_HEIGHT', 96);
...
function generate_image_thumbnail($source_image_path, $thumbnail_image_path)
{
    ...
    $thumbnail_image_width = 96;
    $thumbnail_image_height = 96;
...
define('UPLOADED_IMAGE_DESTINATION', '../src/images/');
define('THUMBNAIL_IMAGE_DESTINATION', '../images/profs/');
